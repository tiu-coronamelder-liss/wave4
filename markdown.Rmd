...
# Header labels
ft <- set_header_labels(ft, values = list("vardesc" = "Variabele", "est.std" = "B", "pvalue" = "p"))
...
# Header labels
ft <- set_header_labels(ft, values = list("vardesc" = "Variabele", "estimates" = "b", "pvalue" = "p"))
...
#Model fit Log reg
dftab <- data.frame(Model = c("Context-gerelateerde variabelen"), 'Pseudo-R-squared' = c('.295'), 'AIC' = c('1172.5'))
