...
data_currentwave_wavemin1$user_status_intention_cw[data_currentwave_wavemin1$Behavior_UTAUT_cw == "Ik gebruik de CoronaMelder app op dit moment"] <- "Gebruiker_cw"
data_currentwave_wavemin1$user_status_intention_cw[(data_currentwave_wavemin1$Behavior_UTAUT_cw == "Ik heb de CoronaMelder app nooit gebruikt") & (data_currentwave_wavemin1$BI1a_UTAUT_cw == 'Helemaal mee oneens'| data_currentwave_wavemin1$BI1a_UTAUT_cw == 'Oneens'| data_currentwave_wavemin1$BI1a_UTAUT_cw == 'Een beetje oneens')] <- "Nooit gebruikt en niet van plan_cw"
data_currentwave_wavemin1$user_status_intention_cw[(data_currentwave_wavemin1$Behavior_UTAUT_cw == "Ik heb de CoronaMelder app nooit gebruikt") & (data_currentwave_wavemin1$BI1a_UTAUT_cw == 'Neutraal')] <- "Nooit gebruikt en neutraal_cw"
data_currentwave_wavemin1$user_status_intention_cw[(data_currentwave_wavemin1$Behavior_UTAUT_cw == "Ik heb de CoronaMelder app nooit gebruikt") & (data_currentwave_wavemin1$BI1a_UTAUT_cw == 'Helemaal mee eens'| data_currentwave_wavemin1$BI1a_UTAUT_cw == 'Mee eens'| data_currentwave_wavemin1$BI1a_UTAUT_cw == 'Een beetje mee eens')] <- "Nooit gebruikt en wel van plan_cw"
data_currentwave_wavemin1$user_status_intention_cw[data_currentwave_wavemin1$Behavior_UTAUT_cw == "Ik heb de CoronaMelder app in het verleden wel gebruikt maar op dit moment niet meer"] <- "Voormalig gebruiker_cw"

# Previous wave
data_currentwave_wavemin1$user_status_intention_wmin1[data_currentwave_wavemin1$Behavior_UTAUT_wmin1 == "Ik gebruik de CoronaMelder app op dit moment"] <- "Gebruiker_wmin1"
data_currentwave_wavemin1$user_status_intention_wmin1[(data_currentwave_wavemin1$Behavior_UTAUT_wmin1 == "Ik heb de CoronaMelder app nooit gebruikt") & (data_currentwave_wavemin1$BI1a_UTAUT_wmin1 == 'Helemaal mee oneens'| data_currentwave_wavemin1$BI1a_UTAUT_wmin1 == 'Oneens'| data_currentwave_wavemin1$BI1a_UTAUT_wmin1 == 'Een beetje oneens')] <- "Nooit gebruikt en niet van plan_wmin1"
data_currentwave_wavemin1$user_status_intention_wmin1[(data_currentwave_wavemin1$Behavior_UTAUT_wmin1 == "Ik heb de CoronaMelder app nooit gebruikt") & (data_currentwave_wavemin1$BI1a_UTAUT_wmin1 == 'Neutraal')] <- "Nooit gebruikt en neutraal_wmin1"
data_currentwave_wavemin1$user_status_intention_wmin1[(data_currentwave_wavemin1$Behavior_UTAUT_wmin1 == "Ik heb de CoronaMelder app nooit gebruikt") & (data_currentwave_wavemin1$BI1a_UTAUT_wmin1 == 'Helemaal mee eens'| data_currentwave_wavemin1$BI1a_UTAUT_wmin1 == 'Mee eens'| data_currentwave_wavemin1$BI1a_UTAUT_wmin1 == 'Een beetje mee eens')] <- "Nooit gebruikt en wel van plan_wmin1"
data_currentwave_wavemin1$user_status_intention_wmin1[data_currentwave_wavemin1$Behavior_UTAUT_wmin1 == "Ik heb de CoronaMelder app in het verleden wel gebruikt maar op dit moment niet meer"] <- "Voormalig gebruiker_wmin1"
...
In de tabel hieronder is het verloop in gebruikersstatus tussen de huidige en de vorige wave te zien. TODO: tabelopmaak en toelichting.


```{r userstatustime, echo=FALSE, tab.cap="Verloop in gebruikersstatus"}
