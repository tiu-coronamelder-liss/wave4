...
COVIDfactors <- data.frame(data_wave4[,c("HBM_PSus_other2", "HBM_PSev_other2", "Beliefs_fear", "Beliefs_notificationfear", "Beliefs_benefiteconomic", "Beliefs_civicduty", "Beliefs_TrustGovernment", "Beliefs_Protectriskgroups", "Beliefs_falsesecurityx", "Beliefs_Conspiracyx", "Beliefs_monitoringx", "Beliefs_technologyperformance")])
#View(COVIDfactors)

#Remove rows with missing values and keep only complete cases
COVIDfactors=COVIDfactors[complete.cases(COVIDfactors),]
#Create the correlation matrix from bfi_data
COVIDfactors_cor <- cor(COVIDfactors)
#Factor analysis of the data
factors_COVID <- fa(r = COVIDfactors, nfactors = 4)
