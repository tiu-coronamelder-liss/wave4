...
# Create results table
w1ns_adh <- standardizedsolution(fit4_w1) %>% filter(lhs == "AdherenceNS_w1" & op == '~') %>% select(rhs, est.std, pvalue)
...
## SRMR  = .06
## The chi square is significant, but this could be due to the large N. 
summary(fits$fit4, fit.measures = TRUE, standardized = TRUE, ci = TRUE)
...
# Round numbers
ft <- colformat_num(x = ft, big.mark = ".", decimal.mark = ",", digits = 3)
