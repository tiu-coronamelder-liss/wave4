...
library(semPlot) # visualising SEM
...
data_wave1$AdherenceNS_w1 <- rowMeans(data_wave1[, c("AdherenceNotificationMeasuresNosymptoms_Test", "AdherenceNotificationMeasuresNosymptoms_Quarantaine", "AdherenceNotificationMeasuresNoSymptoms_Visits", "AdherenceNotificationMeasuresNosymptoms_CallGP")], na.rm = TRUE)
cronbach(data_wave1[, c("AdherenceNotificationMeasuresNosymptoms_Test", "AdherenceNotificationMeasuresNosymptoms_Quarantaine", "AdherenceNotificationMeasuresNoSymptoms_Visits", "AdherenceNotificationMeasuresNosymptoms_CallGP")])

data_wave1$AdherenceS_w1 <- rowMeans(data_wave1[, c("AdherenceNotificationMeasuresSymptoms_Test", "AdherenceNotificationMeasuresSymptoms_Quarantaine", "AdherenceNotificationMeasuresSymptoms_Visits", "AdherenceNotificationMeasuresSymptoms_CallGP")], na.rm = TRUE)
cronbach(data_wave1[, c("AdherenceNotificationMeasuresSymptoms_Test", "AdherenceNotificationMeasuresSymptoms_Quarantaine", "AdherenceNotificationMeasuresSymptoms_Visits", "AdherenceNotificationMeasuresSymptoms_CallGP")])

data_wave1$AdherenceSelfEfficacy_w1 <- rowMeans(data_wave1[, c("HBM_selfefficacy_Test", "HBM_selfefficacy_Quarantaine", "HBM_selfefficacy_Visits", "HBM_selfefficacy_GP")], na.rm = TRUE)
cronbach(data_wave1[, c("HBM_selfefficacy_Test", "HBM_selfefficacy_Quarantaine", "HBM_selfefficacy_Visits", "HBM_selfefficacy_GP")])

data_wave1$AdherenceBenefits_w1 <- rowMeans(data_wave1[, c("HBM_perceivedbenefits_Test", "HBM_perceivedbenefits_Quarantaine", "HBM_perceivedbenefits_Visits", "HBM_perceivedbenefits_GP")], na.rm = TRUE)
cronbach(data_wave1[, c("HBM_selfefficacy_Test", "HBM_selfefficacy_Quarantaine", "HBM_selfefficacy_Visits", "HBM_selfefficacy_GP")])

data_wave1$AdherenceBarriers_w1 <- rowMeans(data_wave1[, c("HBM_barriers_Test", "HBM_barriers_Quarantaine", "HBM_barriers_Visits", "HBM_barriers_GP")], na.rm = TRUE)
cronbach(data_wave1[, c("HBM_barriers_Test", "HBM_barriers_Quarantaine", "HBM_barriers_Visits", "HBM_barriers_GP")])

data_wave1_adherence <- subset(data_wave1, Behavior_UTAUT != 8)
data_wave4_adherence <- subset(data_wave4, Behavior_UTAUT != 8)
...
data_wave4$Beliefs_datasafety_r = car::recode(data_wave4$Beliefs_datasafety, '1=0; 2=0; 3=1; 4=1; 99=0') #Value 0 = not true / don't know, value 1 = true that data is safe
#View(data_wave4[,c("Beliefs_datasafety","Beliefs_datasafety_r")])
...
#data_wave4$oplcat_r <- car::recode(data_wave4$oplcat, '1=1; 2=1; 3=2; 4=2; 5=3; 6=3')
#View(data_wave4[,c("oplcat","oplcat_r")])
#data_wave4$lftdcat_r <- car::recode(data_wave4$lftdcat, '1=1; 2=1; 3=1; 4=2; 5=2; 6=3; 7=3')
#View(data_wave4[,c("lftdcat","lftdcat_r")])
``` 
...
data_wave4$AdherenceNS <- rowMeans(data_wave4[, c("AdherenceNotificationMeasuresNosymptoms_Test", "AdherenceNotificationMeasuresNosymptoms_Quarantaine", "AdherenceNotificationMeasuresNoSymptoms_Visits", "AdherenceNotificationMeasuresNosymptoms_CallGP")], na.rm = TRUE)
cronbach(data_wave4[, c("AdherenceNotificationMeasuresNosymptoms_Test", "AdherenceNotificationMeasuresNosymptoms_Quarantaine", "AdherenceNotificationMeasuresNoSymptoms_Visits", "AdherenceNotificationMeasuresNosymptoms_CallGP")])

data_wave4$AdherenceS <- rowMeans(data_wave4[, c("AdherenceNotificationMeasuresSymptoms_Test", "AdherenceNotificationMeasuresSymptoms_Quarantaine", "AdherenceNotificationMeasuresSymptoms_Visits", "AdherenceNotificationMeasuresSymptoms_CallGP")], na.rm = TRUE)
cronbach(data_wave4[, c("AdherenceNotificationMeasuresSymptoms_Test", "AdherenceNotificationMeasuresSymptoms_Quarantaine", "AdherenceNotificationMeasuresSymptoms_Visits", "AdherenceNotificationMeasuresSymptoms_CallGP")])

data_wave4$AdherenceSelfEfficacy <- rowMeans(data_wave4[, c("HBM_selfefficacy_Test", "HBM_selfefficacy_Quarantaine", "HBM_selfefficacy_Visits", "HBM_selfefficacy_GP")], na.rm = TRUE)
cronbach(data_wave4[, c("HBM_selfefficacy_Test", "HBM_selfefficacy_Quarantaine", "HBM_selfefficacy_Visits", "HBM_selfefficacy_GP")])

data_wave4$AdherenceBenefits <- rowMeans(data_wave4[, c("HBM_perceivedbenefits_Test", "HBM_perceivedbenefits_Quarantaine", "HBM_perceivedbenefits_Visits", "HBM_perceivedbenefits_GP")], na.rm = TRUE)
cronbach(data_wave4[, c("HBM_selfefficacy_Test", "HBM_selfefficacy_Quarantaine", "HBM_selfefficacy_Visits", "HBM_selfefficacy_GP")])

data_wave4$AdherenceBarriers <- rowMeans(data_wave4[, c("HBM_barriers_Test", "HBM_barriers_Quarantaine", "HBM_barriers_Visits", "HBM_barriers_GP")], na.rm = TRUE)
cronbach(data_wave4[, c("HBM_barriers_Test", "HBM_barriers_Quarantaine", "HBM_barriers_Visits", "HBM_barriers_GP")])
...
summary(fit1, fit.measures = TRUE, standardized = TRUE, ci = TRUE)
...
```{r Regression model Adherence Wave 1}
...
#Regression model
AdherenceS_w1 ~ Adherence_Selfefficacy + Adherence_Benefits + Adherence_Barriers + lftdcat + geslacht

#Covariances between independent vars, see https://www.youtube.com/watch?v=n-ULF6BGVw0 
Adherence_Selfefficacy ~~ Adherence_Benefits + Adherence_Barriers + lftdcat + geslacht
Adherence_Benefits ~~ Adherence_Barriers + lftdcat + geslacht
Adherence_Barriers ~~ lftdcat + geslacht
lftdcat ~~ geslacht'

fit4_w1 <- sem(model4_w1, data = data_wave1, estimator = "WLSMV") #Ordered = TRUE tells us that all the endogenous variables are categorical. #In this case, this is the Behavior_UTAUT var. 
